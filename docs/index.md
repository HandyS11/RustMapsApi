...
<div class="rm-hero">
  <img class="rm-hero-logo" src="images/fav-icon.png" alt="RustMapsApi logo" />
  <h1>RustMapsApi</h1>
  <p class="rm-tagline">
  ...
  <p class="rm-badges">
    ...
    <img src="https://img.shields.io/nuget/v/RustMapsApi.svg?label=NuGet&color=b8402c" alt="NuGet" />
  </p>
</div>

<div class="rm-grid">
  <a class="rm-card" href="articles/client.md">
