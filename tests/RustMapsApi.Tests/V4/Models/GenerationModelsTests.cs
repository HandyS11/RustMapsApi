...
public partial class GenerationModelsTests
{
    ...
    public void MapGenerationStatus_DeserializesStateAndQueue()
    {
        ...
        const string json = "{\"mapId\":\"abc\",\"queuePosition\":3,\"state\":\"generating\",\"currentStep\":\"terrain\"}";
    ...
    {
        var options = RustMapsJsonOptions.Create(GenContext.Default);
        const string json = "{\"concurrent\":{\"current\":1,\"allowed\":5},\"monthly\":{\"current\":10,\"allowed\":100}}";
