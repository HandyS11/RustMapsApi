...
public sealed class MapIntegrityTests
{
    ...
    public void EveryMonumentType_IsMappedOrKnownAssetless()
    {
        ...
        var knownAssetless = new HashSet<MonumentType>
        {
            ...
            MonumentType.Mountain1,
            MonumentType.Mountain2,
            MonumentType.Mountain3,
            MonumentType.Mountain4,
            MonumentType.Mountain5,
            MonumentType.IceLake1,
            MonumentType.IceLake2,
            MonumentType.IceLake3,
            MonumentType.IceLake4,
            MonumentType.LargeGodRock,
            MonumentType.MediumGodRock,
            MonumentType.TinyGodRock,
            MonumentType.ThreeWallRock,
            MonumentType.AnvilRock,
            MonumentType.LakeA,
            MonumentType.LakeB,
            MonumentType.LakeC,
            MonumentType.CanyonA,
            MonumentType.CanyonB,
            MonumentType.CanyonC,
            MonumentType.OasisA,
            MonumentType.OasisB,
            MonumentType.OasisC,
        };
